        ...
        <main className="min-h-screen bg-black text-white flex flex-col items-center justify-center px-6">
            <div className="w-full max-w-sm space-y-8">
                <div className="text-center space-y-2">
                    <h1 className="font-serif text-4xl">The Entry</h1>
                    <p className="font-sans text-xs tracking-widest text-white/50 uppercase">
                        Sign in to access your ritual
                    </p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <RainbowButton className="w-full py-4 uppercase tracking-widest text-xs">
                        {isLoading ? "Authenticating..." : "Enter Void"}
                    </RainbowButton>
                </form>

                <div className="text-center">
                    <Link href="/register" className="font-mono text-xs text-white/40 hover:text-white transition-colors border-b border-transparent hover:border-white pb-1">
                        Request Invitation (Register)
                    </Link>
                </div>
            </div>
        </main>
